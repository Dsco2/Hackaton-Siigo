...
namespace Persistence.Migrations
{
    ...
    [Migration("20200209175504_AddCustomerMigration")]
            ...
            modelBuilder.Entity("Business.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        new { IdCustomer = 1, FirstName = "Daniel", IdTenant = 3, LastName = "Cantor" },
                        new { IdCustomer = 2, FirstName = "Jorge", IdTenant = 3, LastName = "Nuñez" },
                        new { IdCustomer = 3, FirstName = "Ricardo", IdTenant = 3, LastName = "Gomez" },
                        new { IdCustomer = 4, FirstName = "Jessica", IdTenant = 3, LastName = "Gonzalez" },
                        new { IdCustomer = 5, FirstName = "Felipe", IdTenant = 3, LastName = "Rodriguez" },
                        new { IdCustomer = 6, FirstName = "Carolina", IdTenant = 3, LastName = "Uribe" },
                        new { IdCustomer = 7, FirstName = "Diego", IdTenant = 3, LastName = "Ortiz" },
                        new { IdCustomer = 8, FirstName = "Andres", IdTenant = 3, LastName = "Robledo" },
                        new { IdCustomer = 9, FirstName = "Santiago", IdTenant = 3, LastName = "Jimenez" },
                        new { IdCustomer = 10, FirstName = "Juan", IdTenant = 3, LastName = "Santos" },
                        new { IdCustomer = 11, FirstName = "Sofia", IdTenant = 3, LastName = "Robledo" },
                        new { IdCustomer = 12, FirstName = "Ana", IdTenant = 3, LastName = "Cepeda" },
                        new { IdCustomer = 13, FirstName = "Maria", IdTenant = 3, LastName = "Suarez" },
                        new { IdCustomer = 14, FirstName = "Carlos", IdTenant = 3, LastName = "Rubiano" },
                        new { IdCustomer = 15, FirstName = "Enrique", IdTenant = 3, LastName = "Saenz" },
                        new { IdCustomer = 16, FirstName = "Alberto", IdTenant = 3, LastName = "Gomez" },
                        new { IdCustomer = 17, FirstName = "Laura", IdTenant = 3, LastName = "Gonzalez" },
                        new { IdCustomer = 18, FirstName = "Sofia", IdTenant = 3, LastName = "Rodriguez" },
                        new { IdCustomer = 19, FirstName = "Ana", IdTenant = 3, LastName = "Uribe" },
                        new { IdCustomer = 20, FirstName = "Maria", IdTenant = 3, LastName = "Ortiz" }
                    );
                });
